...
public class Login extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            PackageInfo info = getPackageManager().getPackageInfo(
                    "com.goleogo.bioapp",  // replace with your unique package name
    ...
    public static void addInfoFirebase(int contador, User user){
        ...
        if(contador != 0) {
             ...
             */
            final Firebase refUsers = new Firebase("https://bioappleo.firebaseio.com/").child("users").child("user").push();
